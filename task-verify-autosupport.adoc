...
+
https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-managing-connectors.html#connect-to-the-linux-vm["Más información sobre cómo conectarse a la VM de Linux para el conector"^]
