...
.Lo que necesitará
Debe crear un conector para poder cambiar la configuración de BlueXP. https://docs.netapp.com/us-en/cloud-manager-setup-admin/concept-connectors.html#how-to-create-a-connector["Vea cómo"^].
