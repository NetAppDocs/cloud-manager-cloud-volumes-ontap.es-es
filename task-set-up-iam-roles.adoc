...
+
Si planea utilizar Cloud Backup con sus sistemas Cloud Volumes ONTAP, el rol IAM de los nodos debe incluir la segunda política que se muestra a continuación.
