...
A partir del lanzamiento de la versión 3.9.19, el conector requiere los siguientes permisos para crear y gestionar máquinas virtuales de almacenamiento para parejas de alta disponibilidad de Cloud Volumes ONTAP:
...
----
Estos permisos se incluyen en https://docs.netapp.com/us-en/cloud-manager-setup-admin/reference-permissions-gcp.html["Las políticas proporcionadas por NetApp"].
