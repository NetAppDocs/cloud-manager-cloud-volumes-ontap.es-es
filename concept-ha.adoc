...
Para obtener más información, consulte link:reference-networking-aws.html#aws-networking-requirements-for-cloud-volumes-ontap-ha-in-multiple-azs["Requisitos de red de AWS para alta disponibilidad de Cloud Volumes ONTAP en múltiples AZS"].
...
Puede identificar fácilmente la dirección IP correcta de BlueXP:
