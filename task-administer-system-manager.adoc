...
+
image:screenshot-cvo-advanced-view.png["Captura de pantalla de un entorno de trabajo de Cloud Volumes ONTAP que muestra la opción Cambiar a vista avanzada."]
...
+
image:screenshot-cvo-standard-view.png["Captura de pantalla de un entorno de trabajo de Cloud Volumes ONTAP que muestra la opción Cambiar a vista estándar."]
