...
TIP: Puede gestionar las suscripciones de Azure Marketplace asociadas con sus cuentas de Azure desde la página Settings > Credentials. https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-azure-accounts.html["Aprenda a gestionar sus cuentas y suscripciones de Azure"^]
