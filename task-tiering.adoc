...
----
Los permisos se incluyen de forma predeterminada en la función personalizada. https://docs.netapp.com/us-en/cloud-manager-setup-admin/reference-permissions-azure.html["Ver permiso de Azure para el conector"^]
...
. En la página lienzo, haga doble clic en el nombre de la instancia de Cloud Volumes ONTAP.
. Haga clic en el icono de menú y seleccione *Activar organización en niveles de capacidad*.
+
image:screenshot_enable_capacity_tiering.gif["Una captura de pantalla de la opción Activar organización por niveles de capacidad disponible en el menú entorno de trabajo si se produjo un problema cuando BlueXP intentó activar la organización por niveles de datos."]

+
Solo verá esta opción si no se pudo habilitar la organización en niveles de datos cuando BlueXP creó el sistema.
...
. Haga clic en el icono de menú, haga clic en *Avanzado* y, a continuación, en *asignación avanzada*.
. Compruebe si la organización en niveles está habilitada o deshabilitada en el agregado.
+
image:screenshot_aggr_tiering.gif["Captura de pantalla que muestra información acerca de un agregado en BlueXP que incluye el estado de organización en niveles."]
...
+
Para obtener ayuda sobre la replicación de datos, consulte https://docs.netapp.com/us-en/cloud-manager-replication/task-replicating-data.html["Replicar datos hacia y desde el cloud"^].
...
Si habilitó la organización en niveles de datos en un volumen Cloud Volumes ONTAP mediante la política _auto_ Tiering, puede ajustar el período de refrigeración predeterminado en función de las necesidades del negocio. Esta acción solo es compatible con la API.
